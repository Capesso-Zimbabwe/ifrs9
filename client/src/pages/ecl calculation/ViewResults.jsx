...
function ViewResults() {
        ...
        >
          {columns.map((col, colIndex) => {
            ...
            return (
              <td 
                key={colIndex} 
                className="border border-gray-300 px-2 py-1 whitespace-nowrap overflow-hidden text-ellipsis"
                style={{ 
  ...
  return (
    <div className="bg-white w-full p-4 rounded s">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        <h1 className="text-xl font-bold text-gray-800">ECL Results</h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Fetch Button */}
          <button
            className="p-1.5 text-white bg-gray-300 rounded hover:bg-gray-400 disabled:opacity-50"
          ...
          {data.length > 0 && (
            <button
              className="p-1.5 text-white bg-gray-300 rounded hover:bg-gray-400"
              onClick={downloadCSV}
      ...
      {loading ? (
        ...
        <div className="overflow-auto max-h-[500px] border border-gray-300 rounded-sm">
          <div style={{ width: tableWidth + "px", minWidth: "100%" }}>
            ...
            <div style={{ display: "flex" }} className="sticky top-0 z-10">
              {columns.map((col) => (
                <div
                  key={col}
                  className="border border-gray-300 px-2 py-2 bg-gray-100 text-gray-700 whitespace-nowrap"
                  style={{ 
