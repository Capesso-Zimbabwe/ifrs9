    ...
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="p-6 space-y-6">
        <div className="flex flex-col space-y-2">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-semibold text-gray-800">View Loaded Data</h1>
            <button 
              onClick={() => navigate('/load-data')}
              className="px-4 py-2 bg-[#E95900] text-white rounded-md hover:bg-blue-700 transition-colors"
            >
              Upload Input Data
            </button>
          </div>
        ...
        <div className="bg-white rounded- shadow-sm px-6 py-2">
      ...
      <div className="px-6">
        ...
        {!loading && !error && selectedDate && data.length === 0 && (
          <div className="mb-6 p-4 bg-gray-50 text-gray-700 rounded-md text-center">
