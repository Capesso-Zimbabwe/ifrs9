...
import logo from '../assets/capesso-logo.png';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side with navy blue gradient background */}
      <div className="w-[60%] bg-gradient-to-r from-[#011325] to-white flex items-center justify-center">
        <h1 className="text-[#011325] text-6xl font-bold mr-[20%]">IFRS 9</h1>
      </div>
