...
const CashflowConfig = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-6">Cashflow Configuration</h1>
 <hr  className='border-t-2 border-gray-100'/>
      ...
      <div className="bg-white rounded-lg  p-6 mb-6">
        <div className="space-y-6">
          <div>
            <h4 className="text-lg font-medium mb-2">Formula</h4>
            <code className="block p-3 rounded-md text-lg">
