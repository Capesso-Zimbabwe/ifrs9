    ...
    return (
        <div className="bg-white rounded-lg shadow p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-3 items-end">
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className="w-full px-2 py-1 text-sm rounded-md border border-gray-300 shadow-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 focus:outline-none transition-colors"
                        />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="md:col-span-2">
                        <button
                            ...
                            className="w-full px-3 py-1 text-sm bg-orange-600 text-white rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors flex items-center justify-center space-x-2"
                        >
            ...
            {reportData && (
                <div className="flex justify-end space-x-4 mb-4">
                    ...
                    <button
                        ...
                        className="px-3 py-1 text-xs bg-orange-600 text-white rounded-md hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors flex items-center space-x-1"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="overflow-x-auto rounded-lg border border-gray-200">
                {error && (
                    <div className="p-3 text-red-700 bg-red-100 rounded-lg mb-3 flex items-center text-xs">
                ...
                {loading ? (
                    <div className="p-4 text-center">
                        <div className="inline-block animate-spin rounded-full h-6 w-6 border-3 border-orange-500 border-t-transparent"></div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 text-xs">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-3 py-2 text-left text-xs font-medium text-black tracking-wider  border-gray-300">Movement Description</th>
                                <th className="px-3 py-2 text-left text-xs font-medium text-black tracking-wider  border-gray-300">Stage 1</th>
                                <th className="px-3 py-2 text-left text-xs font-medium text-black tracking-wider  border-gray-300">Stage 2</th>
                                <th className="px-3 py-2 text-left text-xs font-medium text-black tracking-wider  border-gray-300">Stage 3</th>
                                <th className="px-3 py-2 text-left text-xs font-medium text-black tracking-wider  border-gray-300">Total</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                {[1, 2, 3].map(stage => {
                                    ...
                                    return (
                                        <td key={stage} className="px-3 py-2 whitespace-nowrap text-xs text-gray-500">
                            ...
                            <tr className="bg-gray-100">
                                ...
                                {[1, 2, 3].map(stage => {
                                    ...
                                    return (
                                        <td key={stage} className="px-3 py-2 whitespace-nowrap text-xs font-bold text-gray-900">
                                            {formatNumber(data.amount)}
                                            {showAccountNumbers && (
