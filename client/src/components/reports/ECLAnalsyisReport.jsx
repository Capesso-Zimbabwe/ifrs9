...
function ECLAnalsyisReport() {
  ...
  const fetchAnalysis = () => {
    ...
    setError("");
    axios
      .get(`${API_URL}/reports/ecl-full-analysis`, {
        params: {
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4  py-2 bg-white flex-wrap">
        ...
        <div className="flex gap-2 items-center">
          <input
            type="date"
            className="border border-gray-300 px-3 py-1.5 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            value={ficMisDate}
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            className="flex items-center justify-center gap-2 bg-gray-300 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
  ...
  <div className="flex items-center justify-between">
    <h2 className="text-lg font-semibold text-gray-800">Totals by Currency</h2>
  ...
  {viewMode === "table" ? (
    ...
    <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
      ...
      />
          ...
          {/* By Stage */}
          <div>
            <h2 className="font-semibold mb-2">Breakdown by IFRS Stage</h2>
            {viewMode === "table" ? (
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs border">
                  <thead>
                    <tr>
                      <th className="border px-2 py-1 bg-gray-100">Stage</th>
                      <th className="border px-2 py-1 bg-gray-100">Accounts</th>
                      <th className="border px-2 py-1 bg-gray-100">EAD</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          {/* By Segment */}
          <div>
            <h2 className="font-semibold mb-2">Breakdown by Product Segment</h2>
            {viewMode === "table" ? (
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs border">
                  <thead>
                    <tr>
                      <th className="border px-2 py-1 bg-gray-100">Segment</th>
                      <th className="border px-2 py-1 bg-gray-100">EAD</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div>
            <h2 className="font-semibold  mb-2">Delinquency Distribution</h2>
            {viewMode === "table" ? (
              <div className="overflow-x-auto">
                <div className="rounded-sm overflow-hidden border border-gray-300 shadow">
                  <table className="min-w-full text-xs">
                    <thead>
                      <tr className="bg-gray-300">
                        <th className="text-start px-3 py-2 font-medium text-gray-700">
                          Delinquency Band
                        </th>
                        <th className="text-start px-3 py-2 font-medium text-gray-700">
                          Accounts
          ...
          {/* Top 10 Exposures */}
          <div>
            <h2 className="font-semibold mb-2">Top 10 Exposures</h2>
            {viewMode === "table" ? (
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs border">
                  <thead>
                    <tr>
                      <th className="border px-2 py-1 bg-gray-100">Account</th>
                      <th className="border px-2 py-1 bg-gray-100">EAD</th>
                    </tr>
                  </thead>
                  <tbody>
