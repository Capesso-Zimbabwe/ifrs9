...
function Configuration() {
  ...
  return (
    <div className="w-full bg-white ">
      <h1 className="text-lg font-bold mb-4">ECL Extraction Column Configuration</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 max-h-96 overflow-y-auto border border-gray-300 rounded p-2 mb-4">
          {ALL_COLUMNS.map(col => (
            <label key={col} className="flex items-center text-xs">
              <input
                type="checkbox"
                className="mr-2 accent-[#E95900]"
      ...
      <div className="flex gap-2">
        <button
          className="px-3 py-1 bg-[#E95900] text-white rounded text-xs hover:bg-[#E95900] disabled:opacity-50"
          onClick={handleSave}
