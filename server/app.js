...
app.use('/api/pd-term-structure-details', pdTermStructureDTLRoutes)
app.use('/api/lgd-term-structures', lgdConfigRoutes)
...
app.use('/api/reports',EclAnalysisReportRoutes)
